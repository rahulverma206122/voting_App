    ...
    <div className="min-h-screen bg-slate-50 py-8 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900">Vote for your candidate</h1>
            <p className="text-sm text-slate-500 mt-1">Choose one candidate and cast your vote securely.</p>
          </div>

          <div className="flex gap-3">
            <div className="bg-white border border-slate-100 rounded-xl px-4 py-2 shadow-sm text-center">
              <div className="text-sm font-semibold text-indigo-600">{candidates.length}</div>
              <div className="text-xs text-slate-500">Candidates</div>
            </div>
            <div className="bg-white border border-slate-100 rounded-xl px-4 py-2 shadow-sm text-center">
              <div className="text-sm font-semibold text-indigo-600">{totalLocalVotes}</div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <div className="text-sm text-slate-500 mt-1">
                            {c.party} <span className="mx-1">•</span> Age: {c.age || "-"}
                          </div>
                        </div>

                        <div className="text-right">
                          <div className="text-sm text-slate-500">Votes</div>
                          <div className="text-lg font-extrabold text-indigo-600">{votes}</div>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 flex items-center justify-between gap-3">
                        <div className="flex items-center gap-2">
                          ...
                          */}
                          <button
                            ...
                            disabled={isVoting || !!voting}
                            aria-pressed={false}
                            className={`inline-flex items-center justify-center w-5 h-5 rounded-full text-white shadow-sm transition 
                        ...
                        <div>
                          <button
                            ...
                            className="text-xs px-3 py-2 border rounded-md text-slate-600 hover:bg-slate-50"
                          >
                            +1 preview
                          </button>
                        </div>
